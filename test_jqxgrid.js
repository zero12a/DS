 ...
 b.extend(b.jqx._jqxGrid.prototype, {
  ...
  _initmenu: function() {
   ...
   if (this.host.jqxMenu) {
    ...
    var x = b('<li class="filter ' + n + '" style="height: 194px;" ignoretheme="true"><div class="filter"></div></li>');
     ...
     if (f.columntype == "button") {
      ...
      if (f.columntype == "progressbar" || f.columntype === "rating") {
       if (v.host.jqxButton) {
        ...
        if (d.innerHTML == "") {
         d.progressrow = v.getboundindex(k);
         d.progress = null;
         v._renderprogresscell(v, d, f, k, t)
        }
        if (d.progress && !v.groupable) {
         d.progressrow = v.getboundindex(k);
         d.progress.val(t)
        } else {
         v._renderprogresscell(v, d, f, k, t)
