...
<script src="groupmng.js?<?=getRndVal(10)?>"></script>
<script>
...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	<!--GRP_SEQ오브젝트출력-->						<input type="text" name="G1-GRP_SEQ" value="<?=getFilter(reqPostString("GRP_SEQ",30),"SAFEECHO","")?>" id="G1-GRP_SEQ" style="width:px;" class="">
					</div>
				</div>
			<!--D101: STARTTXT, TAG-->
			<!--I.COLID : GRP_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:px;"-->
					<div class="CON_OBJECT">
	<!--GRP_NM오브젝트출력-->						<input type="text" name="G1-GRP_NM" value="<?=getFilter(reqPostString("GRP_NM",30),"SAFEECHO","")?>" id="G1-GRP_NM" style="width:px;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
