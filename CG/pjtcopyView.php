		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FROM_PJTSEQ오브젝트출력-->
						<input type="text" name="G1-FROM_PJTSEQ" value="<?=getFilter(reqPostString("FROM_PJTSEQ",20),"SAFEECHO","")?>" id="G1-FROM_PJTSEQ" style="width:100px;" class="">
					</div>
				</div>
				<!--I.COLID : TO_PJTSEQ-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--TO_PJTSEQ오브젝트출력-->
						<input type="text" name="G1-TO_PJTSEQ" value="<?=getFilter(reqPostString("TO_PJTSEQ",20),"SAFEECHO","")?>" id="G1-TO_PJTSEQ" style="width:100px;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
