		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="">
						<textarea  name="F4-REQ_BODY"  id="F4-REQ_BODY" style="padding:2px 2px 2px 2px;width:200;height:60px"></textarea>
					</div>
				</div>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!--width:200;height:60-->
					<div class="CON_OBJECT" style="">
						<textarea  name="F4-RES_BODY"  id="F4-RES_BODY" style="padding:2px 2px 2px 2px;width:200;height:60px"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
