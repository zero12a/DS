...
,				{ "COLID": "ADD_DT", "COLNM" : "ADD", "OBJTYPE" : "TEXT" }
,				{ "COLID": "MOD_DT", "COLNM" : "MOD", "OBJTYPE" : "TEXT" }
			]
		}
); //MNU1
grpInfo.set(
...
//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "menumngvController?CTLGRP=G1&CTLFNC=SEARCHALL";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "menumngvController?CTLGRP=G1&CTLFNC=RESET";
// 변수 선언	
//컨트롤러 경로
var url_G2_SEARCH = "menumngvController?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "menumngvController?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_ROWDELETE = "menumngvController?CTLGRP=G2&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G2_ROWADD = "menumngvController?CTLGRP=G2&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G2_RELOAD = "menumngvController?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_EDITMODE = "menumngvController?CTLGRP=G2&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G2_CHKSAVE = "menumngvController?CTLGRP=G2&CTLFNC=CHKSAVE";
//그리드 객체
var wixdtG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;
//컨트롤러 경로
var url_G3_SEARCH = "menumngvController?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "menumngvController?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_ROWDELETE = "menumngvController?CTLGRP=G3&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G3_ROWADD = "menumngvController?CTLGRP=G3&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G3_RELOAD = "menumngvController?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_EDITMODE = "menumngvController?CTLGRP=G3&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G3_CHKSAVE = "menumngvController?CTLGRP=G3&CTLFNC=CHKSAVE";
//그리드 객체
var wixdtG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;
//컨트롤러 경로
var url_G4_SEARCH = "menumngvController?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_ROWADD = "menumngvController?CTLGRP=G4&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G4_CHKSAVE1 = "menumngvController?CTLGRP=G4&CTLFNC=CHKSAVE1";
//컨트롤러 경로
var url_G4_CHKSAVE2 = "menumngvController?CTLGRP=G4&CTLFNC=CHKSAVE2";
//그리드 객체
...
function G2_SEARCH(tinput,token){
	...
	$.ajax({
		...
		error: function(error){
			msgError("[MNU1] Ajax http 500 error ( " + error + " )",3);
			alog("[MNU1] Ajax http 500 error ( " + data.RTN_MSG + " )");
		}
	});
        alog("G2_SEARCH()------------end");
    }
...
function G4_SEARCH(tinput,token){
	...
	$.ajax({
		...
		error: function(error){
			msgError("[미지정PGM] Ajax http 500 error ( " + error + " )",3);
			alog("[미지정PGM] Ajax http 500 error ( " + data.RTN_MSG + " )");
		}
	});
        alog("G4_SEARCH()------------end");
    }
