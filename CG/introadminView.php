...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	-->
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<div class="CON_OBJECT">
			<input type="text" name="G1-FROM_DT" value="" id="G1-FROM_DT" style="width:100px;" class="">
		</div>
	</div>
		<!--D101: STARTTXT, TAG-->
		<!--I.COLID : TO_DT-->
		...
		<div class="CON_OBJECT">
			<input type="text" name="G1-TO_DT" value="" id="G1-TO_DT" style="width:100px;" class="">
		</div>
	</div>
			</div><!-- is_br_tag end -->
		</div>
    ...
    <div class="GRP_OBJECT" style="width:50%;">
		...
		<div class="CON_OBJECT">
			<input type="text" name="G2-FROM_DT" value="" id="G2-FROM_DT" style="width:100px;" class="">
		</div>
	</div>
		<!--D101: STARTTXT, TAG-->
		<!--I.COLID : TO_DT-->
		...
		<div class="CON_OBJECT">
			<input type="text" name="G2-TO_DT" value="" id="G2-TO_DT" style="width:100px;" class="">
		</div>
	</div>
			</DIV><!--is_br_tab end-->
			...
			<!--I.COLID : CFM_DESC-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:100px;"-->
					<div class="CON_OBJECT">
	<!--CFM_DESC오브젝트출력-->						<input type="text" name="G2-CFM_DESC" value="" id="G2-CFM_DESC" style="width:100px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
