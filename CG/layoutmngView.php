...
<script src="layoutmng.js?<?=getRndVal(10)?>"></script>
<script>
...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	<!--LAYOUTID오브젝트출력-->						<input type="text" name="G1-LAYOUTID" value="<?=getFilter(reqPostString("LAYOUTID",30),"SAFEECHO","")?>" id="G1-LAYOUTID" style="width:60px;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
