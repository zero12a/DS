	...
	-->
 	<div class="GRP_OBJECT" style="width:100%;">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
            <div class="GRP_INNER" style="height:38px;">	
		...
		<div style="height:-4px;border-radius:3px;-moz-border-radius: 3px;" class="CONDITION_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SESSIONID오브젝트출력-->
						<input type="text" name="G4-SESSIONID" value="" id="G4-SESSIONID" style="width:60px;" class="">
					</div>
				</div>
			</DIV>
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="width:60px;">
						<select id="G4-ERRCD" name="G4-ERRCD" style="width:60px;min-width:60px"></select>
					</div>
				</div>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="">
						<textarea  name="G4-ERRFILE"  id="G4-ERRFILE" style="padding:2px 2px 2px 2px;width:60;height:500px"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
