...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	-->
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<div class="CONDITION_LABELGRP">
			...
			<div class="CONDITION_LABELBTN">				<input type="button" class="btn btn-secondary  btn-sm"  name="BTN_C1_SEARCHALL" value="조회(전체)" onclick="C1_SEARCHALL(uuidv4());">
	...
	<!--PJTSEQ오브젝트출력-->						<input type="text" name="C1-PJTSEQ" value="<?=getFilter(reqPostString("PJTSEQ",20),"SAFEECHO","")?>" id="C1-PJTSEQ" style="width:30px;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
    ...
    <div class="GRP_OBJECT" style="width:40%;">
		...
		<div class="FORMVIEW_LABELGRP">
			...
			<input type="button" class="btn btn-secondary  btn-sm"  name="BTN_F3_NEW" value="신규" onclick="F3_NEW(uuidv4());">
			<input type="button" class="btn btn-secondary  btn-sm"  name="BTN_F3_MODIFY" value="수정" onclick="F3_MODIFY(uuidv4());">
			<input type="button" class="btn btn-secondary  btn-sm"  name="BTN_F3_DELETE" value="삭제" onclick="F3_DELETE(uuidv4());">
			<input type="button" class="btn btn-secondary  btn-sm"  name="BTN_F3_SAVE" value="저장" onclick="F3_SAVE(uuidv4());">
			<input type="button" class="btn btn-secondary  btn-sm"  name="BTN_F3_RELOAD" value="새로고침" onclick="F3_RELOAD(uuidv4());">
			</div>
		</div>
