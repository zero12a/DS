...
//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_USERDEF = "iconmng2Controller?CTLGRP=G1&CTLFNC=USERDEF";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "iconmng2Controller?CTLGRP=G1&CTLFNC=SEARCHALL";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "iconmng2Controller?CTLGRP=G1&CTLFNC=SAVE";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "iconmng2Controller?CTLGRP=G1&CTLFNC=RESET";
// 변수 선언	
//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_USERDEF = "iconmng2Controller?CTLGRP=G2&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G2_SEARCH = "iconmng2Controller?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "iconmng2Controller?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_RELOAD = "iconmng2Controller?CTLGRP=G2&CTLFNC=RELOAD";
//그리드 객체
...
//폼뷰 컨트롤러 경로
var url_G3_SAVE = "iconmng2Controller?CTLGRP=G3&CTLFNC=SAVE";
//폼뷰 컨트롤러 경로
var url_G3_RELOAD = "iconmng2Controller?CTLGRP=G3&CTLFNC=RELOAD";
//폼뷰 컨트롤러 경로
var url_G3_NEW = "iconmng2Controller?CTLGRP=G3&CTLFNC=NEW";
//폼뷰 컨트롤러 경로
var url_G3_MODIFY = "iconmng2Controller?CTLGRP=G3&CTLFNC=MODIFY";
//폼뷰 컨트롤러 경로
var url_G3_DELETE = "iconmng2Controller?CTLGRP=G3&CTLFNC=DELETE";
//폼뷰 컨트롤러 경로
var url_G3_SEARCH = "iconmng2Controller?CTLGRP=G3&CTLFNC=SEARCH";
...
function G2_INIT(){
  alog("G2_INIT()-------------------------start");
	...
	//헤더초기화
	mygridG2.setHeader("seq,IMGNM,IMGSVRNM,IMGSIZE,IMGHASH,IMGTYPE,IMGTYPE2,IMGTYPE3,IMGTYPE4,CODEMIRROR,TXTAREA,TXTVIEW,HTMLVIEW,SIGNPAD,생성일2,생성일");
	mygridG2.setColumnIds("ICONSEQ,IMGNM,IMGSVRNM,IMGSIZE,IMGHASH,IMGTYPE,IMGTYPE2,IMGTYPE3,IMGTYPE4,CODEMIRROR,TXTAREA,TXTVIEW,HTMLVIEW,SIGNPAD,ADDDT2,ADDDT");
	mygridG2.setInitWidths("70,70,70,70,80,80,80,80,100,80,80,80,80,600,60,60");
	mygridG2.setColTypes("ro,ro,ro,ro,ro,co,co,clist,dropdown,ro,txttxt,txttxt,txttxt,ro,dhxCalendar,ro");
	//가로 정렬	
	mygridG2.setColAlign("left,left,left,left,left,left,left,left,right,left,left,left,left,left,left,left");
	mygridG2.setColSorting("int,str,str,int,str,int,int,str,str,str,str,str,str,str,str,str");	//렌더링	
	mygridG2.enableSmartRendering(false);
	mygridG2.enableMultiselect(true);
	//mygridG2.setColValidators("G2_ICONSEQ,G2_IMGNM,G2_IMGSVRNM,G2_IMGSIZE,G2_IMGHASH,G2_IMGTYPE,G2_IMGTYPE2,G2_IMGTYPE3,G2_IMGTYPE4,G2_CODEMIRROR,G2_TXTAREA,G2_TXTVIEW,G2_HTMLVIEW,G2_SIGNPAD,G2_ADDDT2,G2_ADDDT");
