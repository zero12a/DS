    ...
    <div class="GRP_OBJECT" style="width:50%;">
		...
		<!--I.COLID : LAUTHD_SEQ-->
			<div class="CON_OBJGRP" style="">
				...
				<div class="CON_OBJECT">
					<div name="G4-LAUTHD_SEQ" id="G4-LAUTHD_SEQ" style="background-color:white; width:60px;"></div>
				</div>
			</div>
		...
		<!--I.COLID : ADD_DT-->
			<div class="CON_OBJGRP" style="">
				...
				<!-- style="width:60;"-->
				<div class="CON_OBJECT">
					<div name="G4-ADD_DT" id="G4-ADD_DT" style="background-color:white; width:60px;"></div>
				</div>
			</div>
			</DIV><!--is_br_tab end-->
		</div>
