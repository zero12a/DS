		...
		<div style="height:352px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<div name="G4-LAUTHD_SEQ" id="G4-LAUTHD_SEQ" style="background-color:white; width:60px;height:22px;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="">
						<textarea  name="G4-PREPARE_SQL"  id="G4-PREPARE_SQL" style="padding:2px 2px 2px 2px;width:400;height:160"></textarea>
					</div>
				</div>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!--width:400;height:160-->
					<div class="CON_OBJECT" style="">
						<textarea  name="G4-FULL_SQL"  id="G4-FULL_SQL" style="padding:2px 2px 2px 2px;width:400;height:160"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:60;"-->
					<div class="CON_OBJECT">
						<div name="G4-ADD_DT" id="G4-ADD_DT" style="background-color:white; width:60px;height:22px;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
