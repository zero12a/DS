...
<script src="rdmnuauthmng.js?<?=getRndVal(10)?>"></script>
<script>
 	...
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--MNU_NM오브젝트출력-->
						<input type="text" name="G1-MNU_NM" value="<?=getFilter(reqPostString("MNU_NM",30),"SAFEECHO","")?>" id="G1-MNU_NM" style="width:60pxpx;" class="">
					</div>
				</div>
				<!--I.COLID : AUTH_ID-->
				<div class="CON_OBJGRP" style="">
