 	...
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<div class="CONDITION_LABELGRP">
			<div class="CONDITION_LABEL"  style="">
				...
				<!--fullscreen--><a><img style="cursor:pointer;" class="common-img-btn" src="<?=$CFG["CFG_URL_LIBS_ROOT"]?>img/fullscreen.png" height=10 align=absmiddle border=0 onclick="goFullScreen();"></a>
			</div>	
