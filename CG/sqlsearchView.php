		...
		<div style="height:252px;" class="FORMVIEW_OBJECT">
			...
			<!--OBJECT LIST PRINT.-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:60;"-->
					<div class="CON_OBJECT">
						<div name="G4-SQLID" id="G4-SQLID" style="background-color:white; width:60px;height:22px;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="">
						<textarea  name="G4-SQLTXT"  id="G4-SQLTXT" style="padding:2px 2px 2px 2px;width:400;height:300"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
