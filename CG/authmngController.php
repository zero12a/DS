...
$REQ["G2-AUTH_SEQ"] = reqPostNumber("G2-AUTH_SEQ",10);//AUTH_SEQ, RORW=RO, INHERIT=Y	
...
$REQ["G2-AUTH_NM"] = reqPostString("G2-AUTH_NM",50);//AUTH_NM, RORW=RW, INHERIT=N	
...
//G3, 권한상세 - RW속성 오브젝트만 필터 적용 ( RO속성은 제외 )
