...
<script src="pisvc.js?<?=getRndVal(10)?>"></script>
<script>
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SVCGRPID오브젝트출력-->
						<input type="text" name="G1-SVCGRPID" value="<?=getFilter(reqPostString("SVCGRPID",30),"SAFEECHO","")?>" id="G1-SVCGRPID" style="width:70px;" class="">
					</div>
				</div>
					<!-- FNCSEQ -->
					<div class="CON_OBJECT" style="display:none">
						<input type="text" name="G1-FNCSEQ" value="<?=getFilter(reqGetString("FNCSEQ",30),"SAFEECHO","")?>" id="G1-FNCSEQ">
					</div>
					<!-- GRPSEQ -->
					<div class="CON_OBJECT" style="display:none">
		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SVCSEQ오브젝트출력-->
						<input type="text" name="G3-SVCSEQ" value="" id="G3-SVCSEQ" style="width:70px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SVCGRPID오브젝트출력-->
						<input type="text" name="G3-SVCGRPID" value="" id="G3-SVCGRPID" style="width:70px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
