...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
 	...
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--REMOTE_ADDR오브젝트출력-->
						<input type="text" name="G1-REMOTE_ADDR" value="<?=getFilter(reqPostString("REMOTE_ADDR",20),"SAFEECHO","")?>" id="G1-REMOTE_ADDR" style="width:120px;" class="">
					</div>
				</div>
				<!--I.COLID : FROM_DT-->
				<div class="CON_OBJGRP" style="">
    ...
    <div class="GRP_OBJECT" style="width:65%;">
		...
		<div  class="GRID_OBJECT"  style="">
			<div id="gridG2"  style="background-color:white;overflow:hidden;height:555px;width:100%;"></div>
		</div>
		</div>
	</div>
	<!--
		...
		<div style="height:552px;" class="FORMVIEW_OBJECT">
			...
			<!--OBJECT LIST PRINT.-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--LOGIN_SEQ오브젝트출력-->
						<input type="text" name="G3-LOGIN_SEQ" value="" id="G3-LOGIN_SEQ" style="width:120px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200;"-->
					<div class="CON_OBJECT">
						<div name="G3-SESSION_ID" id="G3-SESSION_ID" style="background-color:white; width:200px;height:22px;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:240;"-->
					<div class="CON_OBJECT">
						<div name="G3-USER_AGENT" id="G3-USER_AGENT" style="background-color:white; width:240px;height:80px;line-height:80px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="">
						<textarea  name="G3-AUTH_JSON"  id="G3-AUTH_JSON" style="padding:2px 2px 2px 2px;width:340;height:460px"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
