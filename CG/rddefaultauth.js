...
//컨트롤러 경로
var url_G3_EXCELLOAD = "rddefaultauthController?CTLGRP=G3&CTLFNC=EXCELLOAD";
//컨트롤러 경로
var url_G3_EXDOWN = "rddefaultauthController?CTLGRP=G3&CTLFNC=EXDOWN";
//그리드 객체
...
function G3_INIT(){
	...
	$("#FILE_G3-EXCELLOAD").on("change", function(e){
		alog("FILE_G3-EXCELLOAD.change().................start");
...
function G3_EXDOWN(tinput,token){
	alog("G3_EXDOWN()------------start");
