...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	<!--USR_ID오브젝트출력-->						<input type="text" name="G1-USR_ID" value="<?=getFilter(reqPostString("USR_ID",10),"SAFEECHO","")?>" id="G1-USR_ID" style="width:200px;" class="">
					</div>
				</div>
			<!--D101: STARTTXT, TAG-->
			<!--I.COLID : USR_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--USR_NM오브젝트출력-->						<input type="text" name="G1-USR_NM" value="<?=getFilter(reqPostString("USR_NM",10),"SAFEECHO","")?>" id="G1-USR_NM" style="width:200px;" class="">
					</div>
				</div>
			<!--D101: STARTTXT, TAG-->
			<!--I.COLID : PHONE-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--PHONE오브젝트출력-->						<input type="text" name="G1-PHONE" value="<?=getFilter(reqPostString("PHONE",20),"SAFEECHO","")?>" id="G1-PHONE" style="width:200px;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
	...
	<!--USR_SEQ오브젝트출력-->						<input type="text" name="G3-USR_SEQ" value="" id="G3-USR_SEQ" style="width:200px;" class="">
			...
			<!--I.COLID : USR_ID-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--USR_ID오브젝트출력-->						<input type="text" name="G3-USR_ID" value="" id="G3-USR_ID" style="width:200px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : USR_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--USR_NM오브젝트출력-->						<input type="text" name="G3-USR_NM" value="" id="G3-USR_NM" style="width:200px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : USR_PWD-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--USR_PWD오브젝트출력-->						<input type="text" name="G3-USR_PWD" value="" id="G3-USR_PWD" style="width:200px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : PHONE-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--PHONE오브젝트출력-->						<input type="text" name="G3-PHONE" value="" id="G3-PHONE" style="width:200px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : PW_ERR_CNT-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--PW_ERR_CNT오브젝트출력-->						<input type="text" name="G3-PW_ERR_CNT" value="" id="G3-PW_ERR_CNT" style="width:200px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<!--I.COLID : LAST_STATUS-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200px;"-->
					<div class="CON_OBJECT">
	<!--LAST_STATUS오브젝트출력-->						<input type="text" name="G3-LAST_STATUS" value="" id="G3-LAST_STATUS" style="width:200px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
