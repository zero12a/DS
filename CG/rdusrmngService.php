...
class rdusrmngService 
{
	...
	public function goG2Userdef(){
		...
		$GRID["COLORD"] = "USR_SEQ,USR_ID,USR_NM,PHONE,USE_YN,USR_PWD,PW_ERR_CNT,LAST_STATUS,LOCK_LIMIT_DT,LOCK_LAST_DT,EXPIRE_DT,PW_CHG_DT,PW_CHG_ID,ADD_DT,MOD_DT"; //그리드 컬럼순서(Hidden컬럼포함)
