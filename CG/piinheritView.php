...
<div id="BODY_BOX" class="BODY_BOX"><!--그룹별 IO출력-->
	...
	<!--CHILDGRPID오브젝트출력-->						<input type="text" name="G1-CHILDGRPID" value="<?=getFilter(reqPostString("CHILDGRPID",40),"SAFEECHO","")?>" id="G1-CHILDGRPID" style="width:80px;" class="">
					</div>
				</div>
					<!-- GRPSEQ -->
		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<!--I.COLID : INHERITSEQ-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:80px;"-->
					<div class="CON_OBJECT">
	<!--INHERITSEQ오브젝트출력-->						<input type="text" name="G3-INHERITSEQ" value="" id="G3-INHERITSEQ" style="width:80px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
	...
	<!--COLID오브젝트출력-->						<input type="text" name="G3-COLID" value="" id="G3-COLID" style="width:100px;" class="">
			...
			<!--I.COLID : CHILDGRPID-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:80px;"-->
					<div class="CON_OBJECT">
	<!--CHILDGRPID오브젝트출력-->						<input type="text" name="G3-CHILDGRPID" value="" id="G3-CHILDGRPID" style="width:80px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
