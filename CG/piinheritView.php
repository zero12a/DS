		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CHILDGRPID오브젝트출력-->
						<input type="text" name="G1-CHILDGRPID" value="<?=getFilter(reqPostString("CHILDGRPID",40),"SAFEECHO","")?>" id="G1-CHILDGRPID" style="width:80px;" class="">
					</div>
				</div>
					<!-- GRPSEQ -->
		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--INHERITSEQ오브젝트출력-->
						<input type="text" name="G3-INHERITSEQ" value="" id="G3-INHERITSEQ" style="width:80px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CHILDGRPID오브젝트출력-->
						<input type="text" name="G3-CHILDGRPID" value="" id="G3-CHILDGRPID" style="width:80px;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
