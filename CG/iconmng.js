...
function G2_INIT(){
  alog("G2_INIT()-------------------------start");
	...
	//헤더초기화
	mygridG2.setHeader("seq,IMGNM,IMGSVRNM,IMGSIZE,IMGHASH,IMGTYPE,IMGTYPE2,IMGTYPE3,CODEMIRROR,TXTAREA,TXTVIEW,HTMLVIEW,SIGNPAD,생성일2,생성일");
	mygridG2.setColumnIds("ICONSEQ,IMGNM,IMGSVRNM,IMGSIZE,IMGHASH,IMGTYPE,IMGTYPE2,IMGTYPE3,CODEMIRROR,TXTAREA,TXTVIEW,HTMLVIEW,SIGNPAD,ADDDT2,ADDDT");
	mygridG2.setInitWidths("70,70,70,70,80,80,80,80,80,80,80,80,600,60,60");
	mygridG2.setColTypes("ro,ro,ro,ro,ro,co,co,clist,ro,txttxt,txttxt,txttxt,ro,dhxCalendar,ro");
	//가로 정렬	
	mygridG2.setColAlign("left,left,left,left,left,left,left,left,left,left,left,left,left,left,left");
	mygridG2.setColSorting("int,str,str,int,str,int,int,str,str,str,str,str,str,str,str");	//렌더링	
	mygridG2.enableSmartRendering(false);
	mygridG2.enableMultiselect(true);
	//mygridG2.setColValidators("G2_ICONSEQ,G2_IMGNM,G2_IMGSVRNM,G2_IMGSIZE,G2_IMGHASH,G2_IMGTYPE,G2_IMGTYPE2,G2_IMGTYPE3,G2_CODEMIRROR,G2_TXTAREA,G2_TXTVIEW,G2_HTMLVIEW,G2_SIGNPAD,G2_ADDDT2,G2_ADDDT");
