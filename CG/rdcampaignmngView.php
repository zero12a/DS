 	...
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:80px;text-align:;overflow:hidden;">
						CAMPAIGN_SEQ
					</div>
					<!-- style="width:60px;"-->
					<div class="CON_OBJECT">
						<!--CAMPAIGN_SEQ오브젝트출력-->
						<input type="text" name="G1-CAMPAIGN_SEQ" value="<?=getFilter(reqPostString("CAMPAIGN_SEQ",30),"SAFEECHO","")?>" id="G1-CAMPAIGN_SEQ" style="width:60px;" class="">
					</div>
				</div>
				<!--I.COLID : CAMPAIGN_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CAMPAIGN_NM오브젝트출력-->
						<input type="text" name="G1-CAMPAIGN_NM" value="<?=getFilter(reqPostString("CAMPAIGN_NM",100),"SAFEECHO","")?>" id="G1-CAMPAIGN_NM" style="width:60px;" class="">
					</div>
				</div>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CONTENT_SVRID오브젝트출력-->
						<input type="text" name="G1-CONTENT_SVRID" value="<?=getFilter(reqPostString("CONTENT_SVRID",100),"SAFEECHO","")?>" id="G1-CONTENT_SVRID" style="width:60px;" class="">
					</div>
				</div>
				<!--I.COLID : CONTENT_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CONTENT_NM오브젝트출력-->
						<input type="text" name="G1-CONTENT_NM" value="<?=getFilter(reqPostString("CONTENT_NM",100),"SAFEECHO","")?>" id="G1-CONTENT_NM" style="width:60px;" class="">
					</div>
				</div>
				<!--I.COLID : CAHNNEL-->
				<div class="CON_OBJGRP" style="">
				...
				<!--I.COLID : ADD_DT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:150pxpx;text-align:left;">
						ADD
					</div>
					<div class="CON_OBJECT">
						<input type="text" name="G1-ADD_DT" value="" id="G1-ADD_DT" style="width:78pxpx;" class="">
					</div>
				</div>
				<!--I.COLID : MOD_DT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:150pxpx;text-align:;">
						MOD
					</div>
					<div class="CON_OBJECT">
						<input type="text" name="G1-MOD_DT" value="" id="G1-MOD_DT" style="width:78pxpx;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
		...
		<div style="height:552px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--TITLE오브젝트출력-->
						<input type="text" name="G3-TITLE" value="" id="G3-TITLE" style="width:300px;" class="">
					</div>
				</div>
				<!--I.COLID : BODY-->
				<div class="CON_OBJGRP" style="width:100%;">
