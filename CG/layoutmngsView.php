...
<script src="layoutmngs.js?<?=getRndVal(10)?>"></script>
<script>
...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--LAYOUTID오브젝트출력-->
						<input type="text" name="G1-LAYOUTID" value="<?=getFilter(reqPostString("LAYOUTID",30),"SAFEECHO","")?>" id="G1-LAYOUTID" style="width:60px;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
	...
	#####################################################
	-->
    <div class="GRP_OBJECT split" style="width:50%;" id="layout_G2">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" style="width:100%;" id="layout_G3">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
		<div  class="GRID_LABELGRP">
			<div class="GRID_LABELGRP_GAP">	<!--그리드만 필요-->
