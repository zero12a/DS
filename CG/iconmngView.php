		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="">
						<textarea  name="G3-TXTAREA"  id="G3-TXTAREA" style="padding:2px 2px 2px 2px;width:80px;height:40px"></textarea>
					</div>
				</div>
				<!--I.COLID : TXTVIEW-->
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:80;"-->
					<div class="CON_OBJECT">
						<div name="G3-TXTVIEW" id="G3-TXTVIEW" style="background-color:white; width:80px;height:30px;line-height:30px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
				<!--I.COLID : HTMLVIEW-->
				<div class="CON_OBJGRP" style="">
			...
			<DIV class="CON_LINE" is_br_tag  style="overflow:visible;z-index:100;">
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<input type="text" name="G3-ADDDT2" value="" id="G3-ADDDT2" style="width:78px;" class="">
					</div>
				</div>
				<!--I.COLID : ADDDT-->
				<div class="CON_OBJGRP" style="">
